...
export function Loader({ overlay }: LoaderProps) {
  return (
    <>
      {overlay && (
        <div className="absolute top-0 right-0 bottom-0 left-0 z-10 bg-black/60"></div>
      )}
      <div className="absolute top-0 right-0 bottom-0 left-0 z-10 flex items-center justify-center gap-2">
